...
import time
from creature_container import *
...
def enemy_encounter_level():
    global enemy_tier
    enemy_tier = randrange(1,11)

def enemy_total():
    global enemy_count
    enemy_count = randrange(1,11)
...
def creature_generator(creature):
    ...
    if enemy_tier > 9:
        creature = Enemy(creature_name(tier3_creatures),randrange(10,15),randrange(10,15),randrange(10,15))

    elif enemy_tier > 7:
        creature = Enemy(creature_name(tier2_creatures),randrange(4,9),randrange(4,9),randrange(4,9))

    else:
        creature = Enemy(creature_name(tier1_creatures),randrange(2,6),randrange(2,6),randrange(2,6))
    
    return creature
    
def creature_name(tier):
    return tier[randrange(0,len(tier))]
